package id.dafa.grid2.Data

import id.dafa.grid2.Model.Topic
import id.dafa.grid2.R
...
object DataSource {
    val topics = listOf(
        ...
        Topic(R.string.lifestyle, 305, R.drawable.img10),
        Topic(R.string.music, 212, R.drawable.img11),
        Topic(R.string.painting, 172, R.drawable.img12),
        Topic(R.string.photography, 321, R.drawable.img13),
        Topic(R.string.tech, 118, R.drawable.img14),
        Topic(R.string.architecture, 58, R.drawable.img1),
        Topic(R.string.crafts, 121, R.drawable.img2),
        Topic(R.string.business, 78, R.drawable.img3),
        Topic(R.string.culinary, 118, R.drawable.img4),
